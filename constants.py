...
# Board
Font = pygame.font.SysFont("comicsans", DIF_BOARD)
resign_font = pygame.font.SysFont("comicsans", int(DIF_BOARD * 3/4))
take_back_font = pygame.font.SysFont("comicsans", int(DIF_BOARD * 2/3))
